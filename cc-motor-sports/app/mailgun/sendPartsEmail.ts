                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            <h1 class="h3  textCenter" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="center">CCMotorsports</h1>
                                            ...
                                            <h5 class="text-teal-700 textCenter" style="color: #13795b; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;" align="center">Here are the details for this customer's order request.</h5>
                                            ...
                                            <p class="text-gray-700 textCenter" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="center">
                                                 From:
                                     <a href='mailto:${partsDetails.email}'>${partsDetails.email}</a>, 
                                                 
                                                 <a href='tel:${partsDetails.phone}'>${partsDetails.phone}</a>


                                              </p>
                                                          <br>
                                              <p class="text-gray-700 textCenter" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="center">
                                              Hello, I have a ${partsDetails.vehicle}: ${partsDetails.year} ${partsDetails.make} ${partsDetails.model} 
                                              <br>
                                              I need these parts:
                                              <br>
                                              ${partsDetails.description}
                                              </p>
                                            </div>
                                            <table class="s-5 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                              <tbody>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;" align="center" bgcolor="#0d6efd">
                                                    <a href="cc-motor-sports.com" target="_blank" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #0d6efd; padding: 8px 12px; border: 1px solid #0d6efd;">Website</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
